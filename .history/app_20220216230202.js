...
addnumbercart.onclick = function(){
    ...
    if(Number(numbercart.textContent) == 0){
        numbercartnotice.classList.add('cart-list--no-cart') ;
        headercart.classList.add('cart-list--no-cart') ;
        numbercartnotice.classList.('cart-list--yes-cart') ;
        headercart.classList.add('cart-list--yes-cart') ;
    }else{
        numbercartnotice.classList.add('cart-list--yes-cart') ;
        headercart.classList.add('cart-list--yes-cart') ;
        numbercartnotice.classList.remove('cart-list--no-cart') ;
        headercart.classList.remove('cart-list--no-cart') ;
    }
}
