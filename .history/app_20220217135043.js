...
const modalMain = document.querySelector('.product-img-main') ;
const modalMainItems = document.querySelectorAll('.product-img-main-item') ;
const modalMainWidth = modalMainItems.offsetWidth ;
const lengh = modalMainItems.length
console.log(const modalMainWidth = modalMainItems.offsetWidth ;
    ) ;
